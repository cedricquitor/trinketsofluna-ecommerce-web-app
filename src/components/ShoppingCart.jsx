                  ...
                  {products.map((product) => {
                    ...
                    return (
                      <tr key={product.productName}>
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center">
                            <div className="flex-shrink-0 h-10 w-10">
                              <img className="h-10 w-10 rounded-full" src={product.productThumbnail} alt="" />
                            </div>
                            <div className="ml-4">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{product.productFeatured}</td>
