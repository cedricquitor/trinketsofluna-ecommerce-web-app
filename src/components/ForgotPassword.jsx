    ...
    <section className="mt-20 flex justify-center">
      <div className="mx-auto my-auto py-8 w-2/3 md:w-1/2 xl:w-1/3 2xl:w-1/4 bg-white shadow-lg">
        ...
        <div className="w-5/6 mx-auto">
          <input type="text" id="email" ref={emailRef} className="h-14 w-full mb-6 px-4 text-xl border-2 border-sky-200 transition placeholder:italic focus:outline-none focus:border-sky-400 hover:border-sky-300" placeholder="Enter your email" />
        </div>
        <div>
          <button onClick={handleSubmit} className="btn--primary w-2/4 mx-auto mb-3">
            Reset Password
          </button>
