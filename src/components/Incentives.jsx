    ...
    <div className="bg-white bg-opacity-70 py-20 mt-28 dark:bg-opacity-100 dark:bg-gray-800 transition duration-500">
      <div className="container mx-auto">
        <div className="text-center">
          <p className="text-gray-500 text-xs px-12 md:text-sm font-lato uppercase tracking-widest dark:text-gray-400">We built our business around customer service.</p>
          <h1 className="font-playfair font-bold text-[2rem] md:text-6xl tracking-tight text-gray-900 dark:text-zinc-100">Why Trinkets of Luna?</h1>
        </div>
        <div className="grid lg:grid-cols-3 sm:grid-cols-1 mt-16">
          <div className="text-center px-16 transition duration-500 hover:-translate-y-4 mb-16 md:mb-8">
          ...
          <div className="text-center px-16 mb-16 transition duration-500 hover:-translate-y-4 md:mb-8">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-24 w-24 mx-auto text-sky-300 dark:text-sky-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
