      ...
      <div className="relative w-full h-full flex items-center">
        ...
        <div id="scroll" className="slider__slides w-11/12 h-full whitespace-nowrap overflow-x-scroll mx-auto scrollbar scroll-smooth">
          {slides.map((slide, slideIndex) => {
            ...
            // TODO: Add key
            return (
              <div key={productName} className="relative bg-white inline-block mx-4">
                <img src={productThumbnail} alt={productName} className="w-[20rem] h-[24rem] object-cover" />
                <div className="mx-4 my-4">
                  <div className="flex justify-between">
                    <h2 className="text-xl font-playfair font-medium">{productName}</h2>
                    <h2 className="bg-gray-100 px-4 text-sm my-auto rounded-2xl text-gray-400 cursor-pointer transition duration-300 hover:bg-gray-300">necklace</h2>
                  </div>
                  <h1 className="text-2xl font-lato font-bold">&#8369;{productPrice}</h1>
                  <div className="flex justify-between">
