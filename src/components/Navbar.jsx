    ...
    <div className={isScrolled ? "fixed top-0 w-full transition duration-500 bg-cyan-50 shadow-xl py-3 z-20" : "fixed top-0 transition duration-300 w-full py-8 bg-transparent z-20"}>
      <div className="container mx-auto flex flex-row justify-between">
        ...
        <div className="flex flex-row font-playfair font-medium my-1">
          <p className={isScrolled ? "ml-16 mr-8 text-md text-gray-600 cursor-pointer transition duration-300 hover:text-cyan-400" : "mr-8 text-xl text-gray-600 cursor-pointer transition duration-300 hover:text-cyan-400"}>Home</p>
        ...
        <div className="mt-2 flex flex-row text-gray-600">
          <svg xmlns="http://www.w3.org/2000/svg" className={isScrolled ? "h-5 w-5 mr-4 cursor-pointer transition duration hover:text-cyan-400" : "h-6 w-6 mr-4 cursor-pointer transition duration hover:text-cyan-400"} fill="none" viewBox="0 0 24 24" stroke="currentColor">
