...
const Personalize = () => {
  return (
    <section className="container bg-white bg-opacity-70 rounded-md mt-36 pt-12 pb-14 justify-center w-10/12 mx-auto dark:bg-gray-800">
      ...
      <div className="mt-8 flex justify-center">
        ...
        <div className="rounded-md shadow">
          <button className="btn--primary md:py-3 md:px-10 active:outline-none">
            Get started
          </button>
        </div>
      </div>
