  ...
  return (
    <div className="container bg-sky-100 rounded-md my-8 pt-12 pb-14 justify-center w-10/12 mx-auto">
      ...
      <div className="mt-8 flex justify-center">
        <input type="text" className="mr-8 px-4 w-1/4 text-xl rounded-md focus:outline-none placeholder:italic" placeholder="Enter your email" />
        <div className="rounded-md shadow">
          <a href="#" className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium shadow-md transition duration-300 rounded-md hover:shadow-2xl text-white bg-sky-300 hover:bg-sky-500 md:py-3 md:text-lg md:px-10 focus:ring-2 focus:ring-offset-2 focus:ring-sky-300 active:bg-sky-600">
            Get started
          </a>
        </div>
      </div>
