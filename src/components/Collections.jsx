  ...
  return (
    <section className="relative container mt-36 w-8/12 mx-auto">
      <div className="text-center my-20">
        ...
        <h1 className="text-6xl 2xl:text-8xl text-gray-900 font-playfair font-extrabold tracking-tight dark:text-zinc-100">Our Collections</h1>
      </div>
      <div className="mt-8 flex flex-col-reverse lg:flex-row relative 2xl:left-20">
        <div className="block mt-12 basis-1/2">
          ...
          <p className="mt-6 2xl:pr-24 font-lato text-xl text-gray-500 dark:text-gray-400">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Consequatur deleniti qui eaque ut sequi unde debitis libero modi tenetur. Laboriosam ipsam porro libero iure eius doloremque voluptate repellendus atque deleniti!</p>
          <p className="mt-6 2xl:pr-24 font-lato text-xl text-gray-500 dark:text-gray-400">Non distinctio eius modi earum provident qui, nesciunt fugit libero quo ex inventore officia, exercitationem tempora ullam necessitatibus porro maxime totam sapiente!</p>
