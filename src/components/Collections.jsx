    ...
    <section className="relative container mt-36 w-8/12 mx-auto ">
      ...
      <div className="mt-8 flex flex-col-reverse lg:flex-row relative 2xl:left-20">
        ...
        <div className="block basis-1/2">
          <img className="2xl:w-3/4 object-cover drop-shadow-2xl" src="https://scontent.fmnl8-2.fna.fbcdn.net/v/t1.6435-9/189144528_4038192529579268_4664427365204957489_n.jpg?_nc_cat=104&ccb=1-5&_nc_sid=0debeb&_nc_eui2=AeGSYzsHCdoFgO2mxkJWqYQtLt69Fkc6cB0u3r0WRzpwHXILLpkEWjPSI3Q1F3VSt5k&_nc_ohc=qEEgLLFTRSwAX8maUfL&_nc_ht=scontent.fmnl8-2.fna&oh=00_AT_6xsc209W1gmcYvdzOumelOItO76LJilKz8Ur6I334QA&oe=6203527C" />
        </div>
      </div>
      <div className="mt-8 flex flex-col lg:flex-row relative 2xl:left-20">
        <div className="block basis-1/2">
          <img className="2xl:w-3/4 object-cover drop-shadow-2xl float-left" src="https://scontent.fmnl8-2.fna.fbcdn.net/v/t1.6435-9/189144528_4038192529579268_4664427365204957489_n.jpg?_nc_cat=104&ccb=1-5&_nc_sid=0debeb&_nc_eui2=AeGSYzsHCdoFgO2mxkJWqYQtLt69Fkc6cB0u3r0WRzpwHXILLpkEWjPSI3Q1F3VSt5k&_nc_ohc=qEEgLLFTRSwAX8maUfL&_nc_ht=scontent.fmnl8-2.fna&oh=00_AT_6xsc209W1gmcYvdzOumelOItO76LJilKz8Ur6I334QA&oe=6203527C" />
        </div>
        <div className="block mt-12 basis-1/2">
