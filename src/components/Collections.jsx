    ...
    <section className="relative container lg:mt-36 w-10/12 2xl:w-8/12 mx-auto">
      ...
      <div className="mt-8 mb-24 flex flex-col-reverse lg:flex-row relative 2xl:left-20">
        <div className="block mt-12 basis-1/2">
          ...
          <p className="mt-6 lg:pr-24 font-lato text-xl text-gray-500 dark:text-gray-400">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Consequatur deleniti qui eaque ut sequi unde debitis libero modi tenetur. Laboriosam ipsam porro libero iure eius doloremque voluptate repellendus atque deleniti!</p>
          <p className="mt-6 lg:pr-24 font-lato text-xl text-gray-500 dark:text-gray-400">Non distinctio eius modi earum provident qui, nesciunt fugit libero quo ex inventore officia, exercitationem tempora ullam necessitatibus porro maxime totam sapiente!</p>
          <p className="mt-8 w-fit text-gray-600 text-2xl font-playfair font-extrabold border-b-2 border-gray-600 cursor-pointer transition duration-200 hover:text-cyan-400 hover:border-cyan-400 hover:-translate-y-1 active:text-cyan-600 active:border-cyan-600 dark:text-gray-300 dark:border-gray-300 dark:hover:border-cyan-500 dark:hover:text-cyan-500 dark:active:text-cyan-600">View Collection</p>
        </div>
      ...
      <div className="mt-8 flex flex-col lg:flex-row relative 2xl:left-20">
        ...
        <div className="block mt-12 basis-1/2 lg:pl-20 2xl:pl-0">
          ...
          <p className="mt-6 lg:pr-4 2xl:pr-24 font-lato text-xl text-gray-500 dark:text-gray-400">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Consequatur deleniti qui eaque ut sequi unde debitis libero modi tenetur. Laboriosam ipsam porro libero iure eius doloremque voluptate repellendus atque deleniti!</p>
          <p className="mt-6 lg:pr-4 2xl:pr-24 font-lato text-xl text-gray-500 dark:text-gray-400">Non distinctio eius modi earum provident qui, nesciunt fugit libero quo ex inventore officia, exercitationem tempora ullam necessitatibus porro maxime totam sapiente!</p>
          <p className="mt-8 w-fit text-gray-600 text-2xl font-playfair font-extrabold border-b-2 border-gray-600 cursor-pointer transition duration-200 hover:text-cyan-400 hover:border-cyan-400 hover:-translate-y-1 active:text-cyan-600 active:border-cyan-600 dark:text-gray-300 dark:border-gray-300 dark:hover:border-cyan-500 dark:hover:text-cyan-500 dark:active:text-cyan-600">View Collection</p>
        </div>
      </div>
    </section>
